"""DataUpdateCoordinator for service_entities."""
...
from .api import (
    ...
    ServiceEntitiesApiClientRateLimitError,
)
...
class BlueprintDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    config_entry: ServiceEntitiesConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        except ServiceEntitiesApiClientRateLimitError as exception:
            raise UpdateFailed(
                exception,
